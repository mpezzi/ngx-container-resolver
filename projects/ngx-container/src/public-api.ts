export * from './lib/classes/resolver';
export * from './lib/interfaces/container.interface';
export * from './lib/interfaces/resolver.interface';
export * from './lib/ngx-container.service';
