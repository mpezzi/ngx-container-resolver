  ...
  template: `
    <ng-container *ngIf="changes as c">
      ...
      <div
        ...
        [class.ngx-container-resolver--loading]="c.loading"
        [class.ngx-container-resolver--loading--first]="
      ...
      >
        ...
        <div
          class="ngx-container-resolver__loading"
          *ngIf="c.loading && !c.data && !c.error"
        >
          <ng-container
            *ngTemplateOutlet="
